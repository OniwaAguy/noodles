...
//updates all values
function reloadall() {
  console.log("Loaded:10073 files!")
  console.log("Downloaded Music mp3!")
  console.error("Image Failed to Download!")
  console.log("Admintraition.js is connected")
  confirm("!LOADED DATA!")
  
  document.getElementById("click").innerHTML =
    "LEVEL:  " + addcomma(moneyup) + " | NoodOre:   " + addcomma(msec);
  document.getElementById("total").innerHTML = " LOADING..  " + addcomma(money);
  document.getElementById("cat").innerHTML =
    catown + "-: " + addcomma(catcost) + " +" + addcomma(catadd) + "/sec";
  document.getElementById("worker").innerHTML =
    workerown + "-: " + addcomma(workercost) + " | +" + addcomma(workadd) + "/sec";
  document.getElementById("upgrade").innerHTML =
    addcomma(upown) + "-: " + addcomma(upcost);
}
...
function myTimer() {
    money += msec;
  document.getElementById("total").innerHTML = "Noodles: " + addcomma(money);
}
...
cboost = 15000;
      ...
      catcost = catcost * 2;
      document.getElementById("cat").innerHTML =
        catown + "-Worker: " + addcomma(catcost) + " | +" + addcomma(catadd * cboost) + "/sec";
    } else if (catown == 50) {
      document.getElementById("cat").innerHTML =
        catown + "-Worker: MAX | +15% click/sec";
    }
  }
...
workadd++;
      ...
      document.getElementById("worker").innerHTML = 
        workerown + "-chef: " + addcomma(workercost) + " | +" + addcomma(workadd * wboost) + "/sec";
    } else if (workerown == 50) {
      document.getElementById("worker").innerHTML =
        workerown + "-chef: MAX | +35% click/sec";
    }
  }
